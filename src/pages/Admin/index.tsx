    ...
    return (
        <div className="flex items-center flex-col min-h-screen pb-7 px-2">
            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
                ...
                <Input placeholder="Digite a URL do link" type="url"
                ...
                {nameInput !== '' && (
                    <div className="flex items-center justify-center mb-7 p-1 border-gray-100/25 border
                                    rounded-md flex-col">
                        <label className="text-white font-medium mt-2 mb-3">Veja como está ficando</label>
                        <article
                            className="w-11/12 max-w-lg flex flex-col items-center justify-center
                                        bg-zinc-900 rounded px-1 py-3"
                ...
                <button className="bg-blue-600 h-9 rounded-md text-white font-medium gap-4 flex
                                    justify-center items-center mb-7"
                        type="submit">
                    Cadastrar
                </button>
            </form>
